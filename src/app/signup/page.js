                        ...
                        <form className="bg-amber-100 h-full flex justify-center items-center "  >
                            <div className=" w-full lg:w-1/2 h-[50%] bg-[#3f97ce] rounded-4xl p-4 mx-10">
                                ...
                                <div className="emailinput mt-10">
                                    <input type="email" name="email" id="email" placeholder="Enter Your  Email...." className="outline-none border-2 border-gray-600 rounded-2xl p-2 w-full" value={logform.email} onChange={handleedit} />
                                </div>
                                ...
                                <button className="bg-amber-400 text-white p-2 rounded-2xl w-1/2 mt-10 cursor-pointer">signup</button>
